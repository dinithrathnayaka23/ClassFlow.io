...
export function AiHelp({ role }: { role: string }) {
  const [messages, setMessages] = useState<ChatItem[]>([
    {
      who: "assistant",
      text: `Hi. I’m ClassFlow Help. Ask me how to use your ${role} workspace.`,
    },
  ]);
  ...
  return (
    <>
      <SectionTitle eyebrow="Platform guidance" title="AI help" />
      <div className="mx-auto max-w-3xl">
        <div className="panel overflow-hidden">
          <div className="flex items-center gap-3 border-b border-line p-5">
            ...
            <div>
              <p className="font-black">ClassFlow Help</p>
              <p className="text-xs text-neon">Online · platform guidance</p>
            </div>
          </div>
          <div className="min-h-[430px] space-y-4 p-5 sm:p-7">
            ...
            {loading && <p className="text-sm text-white/30">Thinking...</p>}
          </div>
          <form
